package edu.ycp.cs320.lab02a_tmcadams.servlet.ajax;
...
import edu.ycp.cs320.lab02a_tmcadams.controller.NumbersController;
import edu.ycp.cs320.lab02a_tmcadams.model.Numbers;
...
public class MultiplyNumbersAjaxServlet extends HttpServlet {
	...
	private void doRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//Multiply the two
		controller.multiply();
		//Return the value by getting it
		result = model.getResultMulti();
